...
namespace SilverbridgeWeb.Modules.Users.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260727222106_AddCommunicationsOfficerRoleAndNewsPermissions")]
    partial class AddCommunicationsOfficerRoleAndNewsPermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PermissionCode = "users:roles:update",
                            RoleName = "Administrator"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Users.Domain.Users.Role", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Users.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("SilverbridgeWeb.Modules.Users.Domain.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("SilverbridgeWeb.Modules.Users.Domain.Users.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("SilverbridgeWeb.Modules.Users.Domain.Users.User", null)
                        .WithMany()
