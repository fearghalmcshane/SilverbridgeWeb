...
namespace SilverbridgeWeb.Modules.News.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            ...
            SELECT EXISTS(
                SELECT 1
                FROM news.outbox_message_consumers
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO news.outbox_message_consumers(outbox_message_id, name)
