...
namespace SilverbridgeWeb.Modules.Ticketing.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260107004638_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.HasOne("SilverbridgeWeb.Modules.Ticketing.Domain.Events.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.HasOne("SilverbridgeWeb.Modules.Ticketing.Domain.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SilverbridgeWeb.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.HasOne("SilverbridgeWeb.Modules.Ticketing.Domain.Orders.Order", null)
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("SilverbridgeWeb.Modules.Ticketing.Domain.Events.TicketType", null)
                        .WithMany()
